...
LOCAL_ARTIFACT_TESTS = frozenset(
    {
        ...
        "tests/test_director_player.py::test_director_availability_prioritizes_bounded_battle_dialogue_recovery",
        "tests/test_director_player.py::test_director_availability_prefers_bounded_outcome_bundle_during_battle_text",
